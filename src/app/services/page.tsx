  ...
  return (
    <LandingPage>
          ...
          <Stack
            ...
            <Typography
              ...
              sx={{
                ...
                lineHeight: 1.05
              }}>Digital services that move your business forward.</Typography>
            <Typography
              sx={{
                fontSize: { xs: 17, md: 19 },
                color: "rgba(255,255,255,.82)",
                maxWidth: 640
              }}>From your first website to smarter systems and measurable growth, we turn ambitious ideas into useful digital products.</Typography>
      ...
      <Box
        sx={{
          py: { xs: 7, md: 11 },
          backgroundImage: "radial-gradient(circle at 5% 10%, rgba(0,141,229,.09), transparent 21rem), radial-gradient(circle at 96% 42%, rgba(109,93,251,.08), transparent 22rem)"
        }}>
        <Container maxWidth="lg">
          <Stack
            spacing={1.5}
            ...
            <Typography
              ...
              sx={{
                ...
                fontWeight: 700
              }}>The right expertise for every stage of growth.</Typography>
          </Stack>
                ...
                <Grid
                  ...
                  <Stack
                    ...
                    sx={{
                      ...
                      "&::before": { content: '""', position: "absolute", width: 140, height: 140, borderRadius: "50%", top: -82, right: -68, bgcolor: service.accent, opacity: .10 },
                      "&:hover": { transform: "translateY(-6px)", boxShadow: "0 18px 34px rgba(18,18,121,.12)" }
                    }}>
                    <Box
                      sx={{
                        width: 48,
        ...
        <Container maxWidth="lg">
          <Stack
            ...
            sx={{
              ...
              fontWeight: 700,
              letterSpacing: 1.2
            }}>HOW WE WORK</Typography><Typography
            component="h2"
            sx={{
              color: "#121279",
              fontWeight: 700,
              fontSize: { xs: 30, md: 42 }
            }}>Simple process. Serious results.</Typography></Stack>
          <Grid container spacing={3}>{process.map(([number, title, detail]) => <Grid
            key={number}
            size={{
              xs: 12,
              md: 4
            ...
            sx={{
              p: 3,
              height: "100%",
              borderLeft: "3px solid #008DE5"
            }}><Typography
            sx={{
              color: "#008DE5",
              fontWeight: 700
            }}>{number}</Typography><Typography
            variant="h5"
            sx={{
              color: "#121279",
              fontWeight: 700
            ...
            color: "#526573"
          }}>{detail}</Typography></Stack></Grid>)}</Grid>
        </Container>
      </Box>
      ...
      <Box
        ...
        sx={{
          ...
          lineHeight: 1.1,
          fontWeight: 700
        }}>Not sure which service you need?</Typography><Typography sx={{
